<script lang="ts">
	...
	import { toDatetimeLocalValue } from '$lib/cms-post-form';
...
<div>
	...
	>
		<div class="grid gap-4 sm:grid-cols-2">
			<CmsTitleSlugFields initialTitle={post.title} initialSlug={post.slug} />
			<div>
				<CmsFieldLabel
					for="kind"
					required
			...
			<div>
				...
				<input
					...
					type="datetime-local"
					class="cms-input"
					value={toDatetimeLocalValue(post.publishedAt)}
				/>
			</div>
		</div>
